...
let AiLogRepository = class AiLogRepository {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    findMany(page, limit, conversationId) {
...
exports.AiLogRepository = AiLogRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], AiLogRepository);
//# sourceMappingURL=ai-log.repository.js.map