...
const settings_dto_1 = require("../dtos/settings.dto");
let SettingsController = class SettingsController {
    ...
    async get() {
        ...
        return api_response_1.ApiResponse.ok(safe);
    }
    async update(dto) {
    ...
    async toggleAi(aiEnabled) {
        ...
        return api_response_1.ApiResponse.ok({ aiEnabled: settings.aiEnabled });
    }
};
...
__decorate([
    (0, common_1.Patch)('ai-toggle'),
    __param(0, (0, common_1.Body)('aiEnabled')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Boolean]),
    __metadata("design:returntype", Promise)
], SettingsController.prototype, "toggleAi", null);
exports.SettingsController = SettingsController = __decorate([
    (0, common_1.Controller)('admin/v1/settings'),
