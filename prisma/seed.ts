...
KHÔNG tự bịa thông tin. CHỈ dùng dữ liệu trong CONTEXT.`,
    ...
    data: [
      {
        question: 'Giờ mở cửa?',
        answer:
          'Dạ bên em mở cửa từ 10h sáng đến 22h tối các ngày trong tuần, cuối tuần đến 23h ạ.',
      ...
      },
      {
        ...
        answer:
          'Dạ nhà hàng em ở 123 Đường Biển, Quận Sơn Trà, Đà Nẵng ạ.',
  ...
  await prisma.menuItem.createMany({
    data: [
      ...
      {
        name: 'Ốc hương nướng',
        category: MenuCategory.MON_NUONG,
